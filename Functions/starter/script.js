...
g();
f();
//F foi redefinido, quando isso acontece ela 'nasce' novamente, então fica atrelada a um novo escopo, perdendo por exemplo a conexão com as variáveis presente na função g
h();
f();
console.dir(f);
